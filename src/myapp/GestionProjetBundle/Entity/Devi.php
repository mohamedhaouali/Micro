 ...
 /**
   ...
   * @Assert\NotBlank()
    */
     ...
     * Set titre
     *
     * @param \myapp\GestionProjetBundle\Entity\Produit $titre
     *
     * @return Devi
     */
    public function setTitre(\myapp\GestionProjetBundle\Entity\Produit $titre = null)
    {
        $this->titre = $titre;
     ...
     * Get titre
     *
     * @return \myapp\GestionProjetBundle\Entity\Produit
     */
